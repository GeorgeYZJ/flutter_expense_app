...
ASCII_BOUND = list(range(65,91)) + list(range(97,123))
ASCII_BOUND.append(44)
ASCII_BOUND.append(46)
ASCII_BOUND.append(32)
    ...
    def mutate(self, child):
        for point in range(self.DNA_size):
            if np.random.rand() < self.mutate_rate:
                child[point] = np.random.choice(self.DNA_bound)  # choose a random ASCII index
        return child
